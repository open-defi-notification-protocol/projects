...
async function testPangolinPendingRewards(address, minimum) {

    const PendingRewards = require('../pangolin/pending-reward');
...
async function testPangolinPositionWorth(address, threshold) {

    const PositionWorth = require('../pangolin/position-worth');
