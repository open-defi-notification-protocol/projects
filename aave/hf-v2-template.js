...
class V2PoolBase {
  ...
  constructor(network) {
    ...
    this.poolContractAddress = addresses["V2"][network];
  }
   ...
   */
  async onInit(args) {
    this.contract = new args.web3.eth.Contract(ABIs.lendingPool, this.poolContractAddress);
  }
  ...
  async onBlocks(args) {
    ...
    const uniqueId = "aave-health-" + this.network + "-v2-" + threshold;
