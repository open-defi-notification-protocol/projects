...
class ChangeStrategy {
    ...
    async onBlocks(args) {
        ...
        return [{
            notification: `No need to rebalance because your ${this.capitalWords(userVault.depositTokenSymbol, "-")} position which making ${userVaultResult.apy}% APY is still the best 🎉`,
            throttleWindowMillis: 3 * 24 * 60 * 60 * 1000,
            uniqueId: userVault.depositTokenSymbol
        }];
    }
