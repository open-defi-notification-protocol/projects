...
const MASTERCHEF_ADDRESS = "0x9083EA3756BDE6Ee6f27a6e996806FBD37F6F093";
...
class PendingReward {
    ...
    async onBlocks(args) {
        ...
        const pendingReward = await this.masterchefContract.methods.pendingSpirit(pid, args.address).call();
